...
void testPdbOccupancies()
{
  ...
  // Use looser substring checks to tolerate platform-specific PDB formatting
  // differences in residue numbering and trailing columns.
  OB_ASSERT(pdb.find("HETATM    1 NA") != string::npos);
  OB_ASSERT(pdb.find("0.325   0.000   4.425") != string::npos);
  OB_ASSERT(pdb.find(" 0.36") != string::npos);
  OB_ASSERT(pdb.find("HETATM   17  O") != string::npos);
  OB_ASSERT(pdb.find("1.954   8.956   3.035") != string::npos);
  OB_ASSERT(pdb.find(" 1.00") != string::npos);
  ...
  OB_ASSERT(pdb.find("0.325   0.000   4.425") != string::npos);
  OB_ASSERT(pdb.find(" 0.36") != string::npos);
  OB_ASSERT(pdb.find("HETATM    2 NA") != string::npos);
  OB_ASSERT(pdb.find("0.002   8.956   1.393") != string::npos);
  OB_ASSERT(pdb.find(" 0.10") != string::npos);
  OB_ASSERT(pdb.find("HETATM   17  O") != string::npos);
  OB_ASSERT(pdb.find("1.954   8.956   3.035") != string::npos);
  OB_ASSERT(pdb.find(" 1.00") != string::npos);
}
